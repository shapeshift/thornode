...
func NewConstantValue() *ConstantVals {
	return &ConstantVals{
		int64values: map[ConstantName]int64{
			...
			StopFundYggdrasil:                  0,                  // stop funding yggdrasil
			...
			NumberOfNewNodesPerChurn:           0,                  // num of new nodes to churn in addition to the ones that churned out
			...
			MintSynths:                         0,                  // enable minting synths
			BurnSynths:                         0,                  // enable burning synths
