...
// YggMgrV27 is an implementation of YggManager
type YggMgrV27 struct {
	keeper keeper.Keeper
}

// NewYggMgrV27 create a new instance of YggMgrV27 which implement YggManager interface
func NewYggMgrV27(keeper keeper.Keeper) *YggMgrV27 {
	return &YggMgrV27{
		keeper: keeper,
	}
}
...
func (ymgr YggMgrV27) Fund(ctx cosmos.Context, mgr Manager, constAccessor constants.ConstantValues) error {
...
// yggdrasil pool
func (ymgr YggMgrV27) sendCoinsToYggdrasil(ctx cosmos.Context, coins common.Coins, ygg Vault, mgr Manager, constAccessor constants.ConstantValues) (int, error) {
	var count int
...
func (ymgr YggMgrV27) shouldFundYggdrasil(ctx cosmos.Context, asgard, ygg Vault, chain common.Chain) bool {
...
func (ymgr YggMgrV27) calcTargetYggCoins(pools []Pool, ygg Vault, yggBond, totalBond, yggFundLimit cosmos.Uint) (common.Coins, error) {
...
func (ymgr YggMgrV27) abandonYggdrasilVaults(ctx cosmos.Context, mgr Manager) error {
...
func (ymgr YggMgrV27) slash(ctx cosmos.Context, slasher Slasher, mgr Manager, pk common.PubKey, ygg Vault) error {
