...
// validatorMgrV51 is to manage a list of validators , and rotate them
type validatorMgrV51 struct {
	k                  keeper.Keeper
...
// newValidatorMgrV51 create a new instance of validatorMgrV51
func newValidatorMgrV51(k keeper.Keeper, vaultMgr NetworkManager, txOutStore TxOutStore, eventMgr EventManager) *validatorMgrV51 {
	return &validatorMgrV51{
		k:          k,
		vaultMgr:   vaultMgr,
		txOutStore: txOutStore,
		eventMgr:   eventMgr,
...
func (vm *validatorMgrV51) BeginBlock(ctx cosmos.Context, constAccessor constants.ConstantValues, existingValidators []string) error {
...
// asgard vaults
func (vm *validatorMgrV51) splitNext(ctx cosmos.Context, nas NodeAccounts, asgardSize int64) []NodeAccounts {
...
func (vm *validatorMgrV51) EndBlock(ctx cosmos.Context, mgr Manager, constAccessor constants.ConstantValues) []abci.ValidatorUpdate {
	height := common.BlockHeight(ctx)
...
func (vm *validatorMgrV51) checkContractUpgrade(ctx cosmos.Context, mgr Manager, removedNodeKeys common.PubKeys) error {
...
func (vm *validatorMgrV51) getChangedNodes(ctx cosmos.Context, activeNodes NodeAccounts) (NodeAccounts, NodeAccounts, error) {
...
func (vm *validatorMgrV51) payNodeAccountBondAward(ctx cosmos.Context, lastChurnHeight int64, na NodeAccount, mgr Manager) error {
...
func (vm *validatorMgrV51) processRagnarok(ctx cosmos.Context, mgr Manager, constAccessor constants.ConstantValues) error {
...
func (vm *validatorMgrV51) getPendingTxOut(ctx cosmos.Context, constAccessor constants.ConstantValues) (int64, error) {
...
func (vm *validatorMgrV51) ragnarokProtocolStage1(ctx cosmos.Context, mgr Manager, constAccessor constants.ConstantValues) error {
	return vm.recallYggFunds(ctx, mgr, constAccessor)
}

func (vm *validatorMgrV51) ragnarokProtocolStage2(ctx cosmos.Context, nth int64, mgr Manager, constAccessor constants.ConstantValues) error {
	// Ragnarok Protocol
...
func (vm *validatorMgrV51) ragnarokBondReward(ctx cosmos.Context, mgr Manager) error {
	var resultErr error
...
func (vm *validatorMgrV51) ragnarokBond(ctx cosmos.Context, nth int64, mgr Manager) error {
...
func (vm *validatorMgrV51) ragnarokPools(ctx cosmos.Context, nth int64, mgr Manager, constAccessor constants.ConstantValues) error {
	nas, err := vm.k.ListActiveValidators(ctx)
	if err != nil {
...
func (vm *validatorMgrV51) RequestYggReturn(ctx cosmos.Context, node NodeAccount, mgr Manager, constAccessor constants.ConstantValues) error {
...
func (vm *validatorMgrV51) recallYggFunds(ctx cosmos.Context, mgr Manager, constAccessor constants.ConstantValues) error {
...
func (vm *validatorMgrV51) setupValidatorNodes(ctx cosmos.Context, height int64, constAccessor constants.ConstantValues) error {
	if height != genesisBlockHeight {
...
func (vm *validatorMgrV51) getScore(ctx cosmos.Context, na NodeAccount, slashPts int64) cosmos.Uint {
...
func (vm *validatorMgrV51) findBadActors(ctx cosmos.Context, minSlashPointsForBadValidator, badValidatorRedline, badValidatorRate int64) (NodeAccounts, error) {
...
func (vm *validatorMgrV51) findOldActor(ctx cosmos.Context) (NodeAccount, error) {
	na := NodeAccount{}
	nas, err := vm.k.ListActiveValidators(ctx)
	if err != nil {
		return na, err
...
func (vm *validatorMgrV51) markOldActor(ctx cosmos.Context, rate int64) error {
...
func (vm *validatorMgrV51) markBadActor(ctx cosmos.Context, minSlashPointsForBadValidator, redline, rate int64) error {
	if common.BlockHeight(ctx)%rate == 0 {
...
func (vm *validatorMgrV51) markLowerVersion(ctx cosmos.Context, rate int64) error {
	if common.BlockHeight(ctx)%rate == 0 {
...
func (vm *validatorMgrV51) markReadyActors(ctx cosmos.Context, constAccessor constants.ConstantValues) error {
...
func (vm *validatorMgrV51) NodeAccountPreflightCheck(ctx cosmos.Context, na NodeAccount, constAccessor constants.ConstantValues) (NodeStatus, error) {
...
func (vm *validatorMgrV51) nextVaultNodeAccounts(ctx cosmos.Context, targetCount int, constAccessor constants.ConstantValues) (NodeAccounts, bool, error) {
