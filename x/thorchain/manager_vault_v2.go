...
func NewVaultMgrV2(k keeper.Keeper, txOutStore TxOutStore, eventMgr EventManager) *VaultMgrV2 {
	return &VaultMgrV2{
		k:          k,
		txOutStore: txOutStore,
		eventMgr:   eventMgr,
...
func (vm *VaultMgrV2) processGenesisSetup(ctx cosmos.Context) error {
...
func (vm *VaultMgrV2) EndBlock(ctx cosmos.Context, mgr Manager, constAccessor constants.ConstantValues) error {
	if common.BlockHeight(ctx) == genesisBlockHeight {
...
func (vm *VaultMgrV2) TriggerKeygen(ctx cosmos.Context, nas NodeAccounts) error {
...
func (vm *VaultMgrV2) RotateVault(ctx cosmos.Context, vault Vault) error {
	active, err := vm.k.GetAsgardVaultsByStatus(ctx, ActiveVault)
	if err != nil {
		return err
	}
...
// and ragnaroks them
func (vm *VaultMgrV2) manageChains(ctx cosmos.Context, mgr Manager, constAccessor constants.ConstantValues) error {
...
// ragnarok'ed
func (vm *VaultMgrV2) findChainsToRetire(ctx cosmos.Context) (common.Chains, error) {
...
func (vm *VaultMgrV2) recallChainFunds(ctx cosmos.Context, chain common.Chain, mgr Manager) error {
...
func (vm *VaultMgrV2) ragnarokChain(ctx cosmos.Context, chain common.Chain, nth int64, mgr Manager, constAccessor constants.ConstantValues) error {
...
func (vm *VaultMgrV2) UpdateVaultData(ctx cosmos.Context, constAccessor constants.ConstantValues, gasManager GasManager, eventMgr EventManager) error {
...
func (vm *VaultMgrV2) getTotalStakedRune(ctx cosmos.Context) (Pools, cosmos.Uint, error) {
...
func (vm *VaultMgrV2) getTotalActiveBond(ctx cosmos.Context) (cosmos.Uint, error) {
...
// Pays out Rewards
func (vm *VaultMgrV2) payPoolRewards(ctx cosmos.Context, poolRewards []cosmos.Uint, pools Pools) error {
...
func (vm *VaultMgrV2) calcPoolDeficit(stakerDeficit, totalFees, poolFees cosmos.Uint) cosmos.Uint {
...
func (vm *VaultMgrV2) calcBlockRewards(totalStaked, totalBonded, totalReserve, totalLiquidityFees cosmos.Uint, emissionCurve, blocksPerYear int64) (cosmos.Uint, cosmos.Uint, cosmos.Uint) {
...
func (vm *VaultMgrV2) getPoolShare(totalStaked, totalBonded, totalRewards cosmos.Uint) cosmos.Uint {
