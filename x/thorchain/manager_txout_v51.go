...
// newTxOutStorageV51 will create a new instance of TxOutStore.
func newTxOutStorageV51(keeper keeper.Keeper, constAccessor constants.ConstantValues, eventMgr EventManager, gasManager GasManager) *TxOutStorageV51 {
	return &TxOutStorageV51{
		keeper:        keeper,
		eventMgr:      eventMgr,
...
func (tos *TxOutStorageV51) EndBlock(ctx cosmos.Context, mgr Manager) error { return nil }
...
func (tos *TxOutStorageV51) prepareTxOutItem(ctx cosmos.Context, toi TxOutItem) ([]TxOutItem, error) {
...
func (tos *TxOutStorageV51) addToBlockOut(ctx cosmos.Context, mgr Manager, toi TxOutItem) error {
...
func (tos *TxOutStorageV51) nativeTxOut(ctx cosmos.Context, mgr Manager, toi TxOutItem) error {
...
func (tos *TxOutStorageV51) collectYggdrasilPools(ctx cosmos.Context, tx ObservedTx, gasAsset common.Asset) (Vaults, error) {
...
func (tos *TxOutStorageV51) deductVaultPendingOutboundBalance(ctx cosmos.Context, vault Vault) (Vault, error) {
...
func (tos *TxOutStorageV51) deductVaultBlockPendingOutbound(vault Vault, block *TxOut) Vault {
