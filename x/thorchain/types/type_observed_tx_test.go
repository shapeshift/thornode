...
func (s TypeObservedTxSuite) TestVoter(c *C) {
	...
	c.Check(voter.HasConsensusV10(trusts3), Equals, true)
	c.Check(voter.HasConsensusV10(trusts4), Equals, false)
...
func (TypeObservedTxSuite) TestSetTxToComplete(c *C) {
	...
	c.Assert(voter.HasConsensusV10(activeNodes), Equals, true)
