...
type YggdrasilManagerV63Suite struct{}

var _ = Suite(&YggdrasilManagerV63Suite{})

func (s YggdrasilManagerV63Suite) TestCalcTargetAmounts(c *C) {
	var pools []Pool
	p := NewPool()
	...
	ymgr := newYggMgrV63(keeper.KVStoreDummy{})
...
func (s YggdrasilManagerV63Suite) TestCalcTargetAmounts2(c *C) {
...
func (s YggdrasilManagerV63Suite) TestCalcTargetAmounts3(c *C) {
...
func (s YggdrasilManagerV63Suite) TestCalcTargetAmounts4(c *C) {
...
func (s YggdrasilManagerV63Suite) TestFund(c *C) {
...
func (s YggdrasilManagerV63Suite) TestNotAvailablePoolAssetWillNotFundYggdrasil(c *C) {
	ctx, k := setupKeeperForTest(c)
	vault := GetRandomVault()
...
func (s YggdrasilManagerV63Suite) TestAbandonYggdrasil(c *C) {
