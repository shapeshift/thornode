...
type SlashingV43Suite struct{}

var _ = Suite(&SlashingV43Suite{})

func (s *SlashingV43Suite) SetUpSuite(c *C) {
	SetupConfigForTest()
}

func (s *SlashingV43Suite) TestObservingSlashing(c *C) {
	var err error
...
func (s *SlashingV43Suite) TestLackObservingErrors(c *C) {
...
func (s *SlashingV43Suite) TestNodeSignSlashErrors(c *C) {
	testCases := []struct {
		name        string
...
func (s *SlashingV43Suite) TestNotSigningSlash(c *C) {
	ctx, _ := setupKeeperForTest(c)
	ctx = ctx.WithBlockHeight(201) // set blockheight
...
func (s *SlashingV43Suite) TestNewSlasher(c *C) {
	nas := NodeAccounts{
		GetRandomValidatorNode(NodeActive),
		GetRandomValidatorNode(NodeActive),
	}
...
func (s *SlashingV43Suite) TestDoubleSign(c *C) {
	ctx, _ := setupKeeperForTest(c)
...
func (s *SlashingV43Suite) TestIncreaseDecreaseSlashPoints(c *C) {
	ctx, _ := setupKeeperForTest(c)
