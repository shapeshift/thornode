...
type YggdrasilManagerV64Suite struct{}

var _ = Suite(&YggdrasilManagerV64Suite{})

func (s YggdrasilManagerV64Suite) TestCalcTargetAmounts(c *C) {
	var pools []Pool
	p := NewPool()
	...
	ymgr := NewYggMgrV64(keeper.KVStoreDummy{})
...
func (s YggdrasilManagerV64Suite) TestCalcTargetAmounts2(c *C) {
...
func (s YggdrasilManagerV64Suite) TestCalcTargetAmounts3(c *C) {
...
func (s YggdrasilManagerV64Suite) TestCalcTargetAmounts4(c *C) {
...
func (s YggdrasilManagerV64Suite) TestFund(c *C) {
...
func (s YggdrasilManagerV64Suite) TestNotAvailablePoolAssetWillNotFundYggdrasil(c *C) {
	ctx, k := setupKeeperForTest(c)
	vault := GetRandomVault()
...
func (s YggdrasilManagerV64Suite) TestAbandonYggdrasilWithDifferentConditions(c *C) {
	ctx, mgr := setupManagerForTest(c)
	vault := GetRandomVault()
	vault.Coins = common.Coins{
		common.NewCoin(common.RuneAsset(), cosmos.NewUint(10000*common.One)),
