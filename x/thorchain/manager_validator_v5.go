...
// validatorMgrV5 is to manage a list of validators , and rotate them
type validatorMgrV5 struct {
	k          keeper.Keeper
...
func newValidatorMgrV5(k keeper.Keeper, vaultMgr VaultManager, txOutStore TxOutStore, eventMgr EventManager) *validatorMgrV5 {
	return &validatorMgrV5{
		k:          k,
		vaultMgr:   vaultMgr,
		txOutStore: txOutStore,
		eventMgr:   eventMgr,
...
func (vm *validatorMgrV5) BeginBlock(ctx cosmos.Context, constAccessor constants.ConstantValues) error {
...
func (vm *validatorMgrV5) EndBlock(ctx cosmos.Context, mgr Manager, constAccessor constants.ConstantValues) []abci.ValidatorUpdate {
	height := common.BlockHeight(ctx)
...
func (vm *validatorMgrV5) getChangedNodes(ctx cosmos.Context, activeNodes NodeAccounts) (NodeAccounts, NodeAccounts, error) {
...
func (vm *validatorMgrV5) payNodeAccountBondAward(ctx cosmos.Context, na NodeAccount) error {
...
func (vm *validatorMgrV5) processRagnarok(ctx cosmos.Context, mgr Manager, constAccessor constants.ConstantValues) error {
...
func (vm *validatorMgrV5) ragnarokProtocolStage1(ctx cosmos.Context, mgr Manager) error {
	return vm.recallYggFunds(ctx, mgr)
}

func (vm *validatorMgrV5) ragnarokProtocolStage2(ctx cosmos.Context, nth int64, mgr Manager, constAccessor constants.ConstantValues) error {
	// Ragnarok Protocol
...
func (vm *validatorMgrV5) ragnarokBondReward(ctx cosmos.Context) error {
...
func (vm *validatorMgrV5) ragnarokReserve(ctx cosmos.Context, nth int64, mgr Manager) error {
...
func (vm *validatorMgrV5) ragnarokBond(ctx cosmos.Context, nth int64, mgr Manager) error {
...
func (vm *validatorMgrV5) ragnarokPools(ctx cosmos.Context, nth int64, mgr Manager, constAccessor constants.ConstantValues) error {
...
func (vm *validatorMgrV5) RequestYggReturn(ctx cosmos.Context, node NodeAccount, mgr Manager) error {
...
func (vm *validatorMgrV5) recallYggFunds(ctx cosmos.Context, mgr Manager) error {
...
func (vm *validatorMgrV5) setupValidatorNodes(ctx cosmos.Context, height int64, constAccessor constants.ConstantValues) error {
	if height != genesisBlockHeight {
...
func (vm *validatorMgrV5) findBadActors(ctx cosmos.Context) (NodeAccounts, error) {
...
func (vm *validatorMgrV5) findOldActor(ctx cosmos.Context) (NodeAccount, error) {
	na := NodeAccount{}
	nas, err := vm.k.ListActiveNodeAccounts(ctx)
	if err != nil {
		return na, err
...
func (vm *validatorMgrV5) markActor(ctx cosmos.Context, na NodeAccount, reason string) error {
...
func (vm *validatorMgrV5) markOldActor(ctx cosmos.Context, rate int64) error {
...
func (vm *validatorMgrV5) markBadActor(ctx cosmos.Context, rate int64) error {
	if common.BlockHeight(ctx)%rate == 0 {
...
func (vm *validatorMgrV5) markLowerVersion(ctx cosmos.Context, rate int64) error {
	if common.BlockHeight(ctx)%rate == 0 {
...
func (vm *validatorMgrV5) findLowerVersionActor(ctx cosmos.Context) (NodeAccount, error) {
...
func (vm *validatorMgrV5) markReadyActors(ctx cosmos.Context, constAccessor constants.ConstantValues) error {
...
func (vm *validatorMgrV5) NodeAccountPreflightCheck(ctx cosmos.Context, na NodeAccount, constAccessor constants.ConstantValues) (NodeStatus, error) {
...
func (vm *validatorMgrV5) nextVaultNodeAccounts(ctx cosmos.Context, targetCount int, constAccessor constants.ConstantValues) (NodeAccounts, bool, error) {
