...
type TxOutStoreV34Suite struct{}

var _ = Suite(&TxOutStoreV34Suite{})

func (s TxOutStoreV34Suite) TestAddGasFees(c *C) {
...
func (s TxOutStoreV34Suite) TestAddOutTxItem(c *C) {
...
func (s TxOutStoreV34Suite) TestAddOutTxItemWithoutBFT(c *C) {
	w := getHandlerTestWrapper(c, 1, true, true)
	vault := GetRandomVault()
	vault.Coins = common.Coins{
		common.NewCoin(common.BNBAsset, cosmos.NewUint(100*common.One)),
