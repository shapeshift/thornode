...
// newSlasherV63 create a new instance of Slasher
func newSlasherV63(keeper keeper.Keeper, eventMgr EventManager) *SlasherV63 {
	return &SlasherV63{keeper: keeper, eventMgr: eventMgr}
}
...
func (s *SlasherV63) slashNotObserving(ctx cosmos.Context, txHash common.TxID, constAccessor constants.ConstantValues) error {
...
func (s *SlasherV63) checkSignerAndSlash(ctx cosmos.Context, nodes NodeAccounts, blockHeight int64, signers []cosmos.AccAddress, constAccessor constants.ConstantValues) {
