...
// newSlasherV47 create a new instance of Slasher
func newSlasherV47(keeper keeper.Keeper, eventMgr EventManager) *SlasherV47 {
	return &SlasherV47{keeper: keeper, eventMgr: eventMgr}
}
...
func (s *SlasherV47) slashNotObserving(ctx cosmos.Context, txHash common.TxID, constAccessor constants.ConstantValues) error {
...
func (s *SlasherV47) checkSignerAndSlash(ctx cosmos.Context, nodes NodeAccounts, blockHeight int64, signers []cosmos.AccAddress, constAccessor constants.ConstantValues) {
