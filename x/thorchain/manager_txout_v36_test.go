...
type TxOutStoreV36Suite struct{}

var _ = Suite(&TxOutStoreV36Suite{})

func (s TxOutStoreV36Suite) TestAddGasFees(c *C) {
...
func (s TxOutStoreV36Suite) TestAddOutTxItem(c *C) {
...
func (s TxOutStoreV36Suite) TestAddOutTxItemWithoutBFT(c *C) {
	w := getHandlerTestWrapper(c, 1, true, true)
	vault := GetRandomVault()
	vault.Coins = common.Coins{
		common.NewCoin(common.BNBAsset, cosmos.NewUint(100*common.One)),
