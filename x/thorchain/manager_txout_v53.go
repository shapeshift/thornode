...
// newTxOutStorageV53 will create a new instance of TxOutStore.
func newTxOutStorageV53(keeper keeper.Keeper, constAccessor constants.ConstantValues, eventMgr EventManager, gasManager GasManager) *TxOutStorageV53 {
	return &TxOutStorageV53{
		keeper:        keeper,
		eventMgr:      eventMgr,
...
func (tos *TxOutStorageV53) EndBlock(ctx cosmos.Context, mgr Manager) error { return nil }
...
func (tos *TxOutStorageV53) prepareTxOutItem(ctx cosmos.Context, toi TxOutItem) ([]TxOutItem, error) {
...
func (tos *TxOutStorageV53) addToBlockOut(ctx cosmos.Context, mgr Manager, toi TxOutItem) error {
...
func (tos *TxOutStorageV53) nativeTxOut(ctx cosmos.Context, mgr Manager, toi TxOutItem) error {
...
func (tos *TxOutStorageV53) collectYggdrasilPools(ctx cosmos.Context, tx ObservedTx, gasAsset common.Asset) (Vaults, error) {
...
func (tos *TxOutStorageV53) deductVaultPendingOutboundBalance(ctx cosmos.Context, vault Vault) (Vault, error) {
...
func (tos *TxOutStorageV53) deductVaultBlockPendingOutbound(vault Vault, block *TxOut) Vault {
