...
// YggMgrV21 is an implementation of YggManager
type YggMgrV21 struct {
	keeper keeper.Keeper
}

// NewYggMgrV21 create a new instance of YggMgrV21 which implement YggManager interface
func NewYggMgrV21(keeper keeper.Keeper) *YggMgrV21 {
	return &YggMgrV21{
		keeper: keeper,
	}
}
...
func (ymgr YggMgrV21) Fund(ctx cosmos.Context, mgr Manager, constAccessor constants.ConstantValues) error {
...
// yggdrasil pool
func (ymgr YggMgrV21) sendCoinsToYggdrasil(ctx cosmos.Context, coins common.Coins, ygg Vault, mgr Manager, constAccessor constants.ConstantValues) (int, error) {
	var count int
...
func (ymgr YggMgrV21) shouldFundYggdrasil(ctx cosmos.Context, asgard, ygg Vault, chain common.Chain) bool {
...
func (ymgr YggMgrV21) calcTargetYggCoins(pools []Pool, ygg Vault, yggBond, totalBond, yggFundLimit cosmos.Uint) (common.Coins, error) {
...
func (ymgr YggMgrV21) abandonYggdrasilVaults(ctx cosmos.Context, mgr Manager) error {
...
func (ymgr YggMgrV21) slash(ctx cosmos.Context, slasher Slasher, mgr Manager, pk common.PubKey, ygg Vault) error {
