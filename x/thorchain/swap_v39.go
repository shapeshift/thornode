...
func (s *SwapperV39) validatePools(ctx cosmos.Context, keeper keeper.Keeper, assets ...common.Asset) error {
...
func (s *SwapperV39) validateMessage(tx common.Tx, target common.Asset, destination common.Address) error {
...
func (s *SwapperV39) swap(ctx cosmos.Context,
...
func (s *SwapperV39) swapOne(ctx cosmos.Context,
...
func (s *SwapperV39) calcAssetEmission(X, x, Y cosmos.Uint) cosmos.Uint {
	// ( x * X * Y ) / ( x + X )^2
...
func (s *SwapperV39) calcLiquidityFee(X, x, Y cosmos.Uint) cosmos.Uint {
	// ( x^2 *  Y ) / ( x + X )^2
	numerator := x.Mul(x).Mul(Y)
	denominator := x.Add(X).Mul(x.Add(X))
	if denominator.IsZero() {
...
func (s *SwapperV39) calcSwapSlip(Xi, xi cosmos.Uint) cosmos.Uint {
	// Cast to DECs
