...
// SlasherV37 is V37 implementation os slasher
type SlasherV37 struct {
	keeper keeper.Keeper
}

// NewSlasherV37 create a new instance of Slasher
func NewSlasherV37(keeper keeper.Keeper) *SlasherV37 {
	return &SlasherV37{keeper: keeper}
}

// BeginBlock called when a new block get proposed to detect whether there are duplicate vote
func (s *SlasherV37) BeginBlock(ctx cosmos.Context, req abci.RequestBeginBlock, constAccessor constants.ConstantValues) {
...
func (s *SlasherV37) HandleDoubleSign(ctx cosmos.Context, addr crypto.Address, infractionHeight int64, constAccessor constants.ConstantValues) error {
...
func (s *SlasherV37) LackObserving(ctx cosmos.Context, constAccessor constants.ConstantValues) error {
...
func (s *SlasherV37) slashNotObserving(ctx cosmos.Context, txHash common.TxID, constAccessor constants.ConstantValues) error {
...
func (s *SlasherV37) checkSignerAndSlash(ctx cosmos.Context, nodes NodeAccounts, blockHeight int64, signers []cosmos.AccAddress, constAccessor constants.ConstantValues) {
...
func (s *SlasherV37) LackSigning(ctx cosmos.Context, constAccessor constants.ConstantValues, mgr Manager) error {
	var resultErr error
	signingTransPeriod := constAccessor.GetInt64Value(constants.SigningTransactionPeriod)
...
func (s *SlasherV37) SlashNodeAccount(ctx cosmos.Context, observedPubKey common.PubKey, asset common.Asset, slashAmount cosmos.Uint, mgr Manager) error {
...
// it will slash the node account who does that by taking 1.5 * extra fund from
// node account's bond and subsidise the pool that actually lost it.
func (s *SlasherV37) SlashVault(ctx cosmos.Context, vaultPK common.PubKey, coins common.Coins, mgr Manager) error {
	if coins.IsEmpty() {
		return nil
	}
...
func (s *SlasherV37) IncSlashPoints(ctx cosmos.Context, point int64, addresses ...cosmos.AccAddress) {
...
func (s *SlasherV37) DecSlashPoints(ctx cosmos.Context, point int64, addresses ...cosmos.AccAddress) {
	for _, addr := range addresses {
