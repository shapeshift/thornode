...
// newTxOutStorageV66 will create a new instance of TxOutStore.
func newTxOutStorageV66(keeper keeper.Keeper, constAccessor constants.ConstantValues, eventMgr EventManager, gasManager GasManager) *TxOutStorageV66 {
	return &TxOutStorageV66{
		keeper:        keeper,
		eventMgr:      eventMgr,
...
func (tos *TxOutStorageV66) TryAddTxOutItem(ctx cosmos.Context, mgr Manager, toi TxOutItem) (bool, error) {
	...
	if !toi.InHash.IsEmpty() && !toi.InHash.Equals(common.BlankTxID) {
...
func (tos *TxOutStorageV66) prepareTxOutItem(ctx cosmos.Context, toi TxOutItem) ([]TxOutItem, error) {
...
func (tos *TxOutStorageV66) addToBlockOut(ctx cosmos.Context, mgr Manager, item TxOutItem, outboundHeight int64) error {
...
func (tos *TxOutStorageV66) calcTxOutHeight(ctx cosmos.Context, version semver.Version, toi TxOutItem) (int64, error) {
...
func (tos *TxOutStorageV66) nativeTxOut(ctx cosmos.Context, mgr Manager, toi TxOutItem) error {
...
func (tos *TxOutStorageV66) collectYggdrasilPools(ctx cosmos.Context, tx ObservedTx, gasAsset common.Asset) (Vaults, error) {
...
func (tos *TxOutStorageV66) deductVaultPendingOutboundBalance(ctx cosmos.Context, vault Vault) (Vault, error) {
...
func (tos *TxOutStorageV66) deductVaultBlockPendingOutbound(vault Vault, block *TxOut) Vault {
