...
type GasManagerV34TestSuite struct{}

var _ = Suite(&GasManagerV34TestSuite{})

func (GasManagerV34TestSuite) TestGasManagerV34(c *C) {
	ctx, k := setupKeeperForTest(c)
	constAccessor := constants.GetConstantValues(GetCurrentVersion())
	gasMgr := NewGasMgrV34(constAccessor, k)
...
func (GasManagerV34TestSuite) TestGetFee(c *C) {
	ctx, k := setupKeeperForTest(c)
	constAccessor := constants.GetConstantValues(GetCurrentVersion())
	gasMgr := NewGasMgrV34(constAccessor, k)
...
func (GasManagerV34TestSuite) TestDifferentValidations(c *C) {
	ctx, k := setupKeeperForTest(c)
	constAccessor := constants.GetConstantValues(GetCurrentVersion())
	gasMgr := NewGasMgrV34(constAccessor, k)
	gasMgr.BeginBlock()
