...
func (pm *PoolMgrV73) cyclePools(ctx cosmos.Context, maxAvailablePools, minRunePoolDepth, stagedPoolCost int64, mgr Manager) error {
...
func (pm *PoolMgrV73) removeAssetFromVault(ctx cosmos.Context, asset common.Asset, mgr Manager) {
...
func (pm *PoolMgrV73) removeLiquidityProviders(ctx cosmos.Context, asset common.Asset, mgr Manager) {
