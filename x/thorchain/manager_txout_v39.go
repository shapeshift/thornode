...
// TxOutStorageV39 is going to manage all the outgoing tx
type TxOutStorageV39 struct {
...
// NewTxOutStorageV39 will create a new instance of TxOutStore.
func NewTxOutStorageV39(keeper keeper.Keeper, constAccessor constants.ConstantValues, eventMgr EventManager, gasManager GasManager) *TxOutStorageV39 {
	return &TxOutStorageV39{
		keeper:        keeper,
		eventMgr:      eventMgr,
...
func (tos *TxOutStorageV39) GetBlockOut(ctx cosmos.Context) (*TxOut, error) {
	return tos.keeper.GetTxOut(ctx, common.BlockHeight(ctx))
}

// GetOutboundItems read all the outbound item from kv store
func (tos *TxOutStorageV39) GetOutboundItems(ctx cosmos.Context) ([]TxOutItem, error) {
...
func (tos *TxOutStorageV39) GetOutboundItemByToAddress(ctx cosmos.Context, to common.Address) []TxOutItem {
...
func (tos *TxOutStorageV39) ClearOutboundItems(ctx cosmos.Context) {
...
func (tos *TxOutStorageV39) TryAddTxOutItem(ctx cosmos.Context, mgr Manager, toi TxOutItem) (bool, error) {
...
// fee deduction, etc
func (tos *TxOutStorageV39) UnSafeAddTxOutItem(ctx cosmos.Context, mgr Manager, toi TxOutItem) error {
...
func (tos *TxOutStorageV39) prepareTxOutItem(ctx cosmos.Context, toi TxOutItem) ([]TxOutItem, error) {
...
func (tos *TxOutStorageV39) addToBlockOut(ctx cosmos.Context, mgr Manager, toi TxOutItem) error {
...
func (tos *TxOutStorageV39) nativeTxOut(ctx cosmos.Context, mgr Manager, toi TxOutItem) error {
...
func (tos *TxOutStorageV39) collectYggdrasilPools(ctx cosmos.Context, tx ObservedTx, gasAsset common.Asset) (Vaults, error) {
...
func (tos *TxOutStorageV39) deductVaultPendingOutboundBalance(ctx cosmos.Context, vault Vault) (Vault, error) {
...
func (tos *TxOutStorageV39) deductVaultBlockPendingOutbound(vault Vault, block *TxOut) Vault {
