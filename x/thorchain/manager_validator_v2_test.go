...
type ValidatorMgrV2TestSuite struct{}

var _ = Suite(&ValidatorMgrV2TestSuite{})

func (vts *ValidatorMgrV2TestSuite) SetUpSuite(c *C) {
	SetupConfigForTest()
}

func (vts *ValidatorMgrV2TestSuite) TestSetupValidatorNodes(c *C) {
...
func (vts *ValidatorMgrV2TestSuite) TestRagnarokForChaosnet(c *C) {
	ctx, k := setupKeeperForTest(c)
	mgr := NewManagers(k)
...
func (vts *ValidatorMgrV2TestSuite) TestBadActors(c *C) {
	ctx, k := setupKeeperForTest(c)
...
func (vts *ValidatorMgrV2TestSuite) TestRagnarokBond(c *C) {
	ctx, k := setupKeeperForTest(c)
	ctx = ctx.WithBlockHeight(1)
	ver := constants.SWVersion
...
func (vts *ValidatorMgrV2TestSuite) TestFindCounToRemove(c *C) {
	// remove one
...
func (vts *ValidatorMgrV2TestSuite) TestFindMaxAbleToLeave(c *C) {
