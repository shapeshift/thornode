...
type TxOutStoreV39Suite struct{}

var _ = Suite(&TxOutStoreV39Suite{})

func (s TxOutStoreV39Suite) TestAddGasFees(c *C) {
...
func (s TxOutStoreV39Suite) TestAddOutTxItem(c *C) {
...
func (s TxOutStoreV39Suite) TestAddOutTxItemNotEnoughForFee(c *C) {
	w := getHandlerTestWrapper(c, 1, true, true)
	vault := GetRandomVault()
	vault.Coins = common.Coins{
		common.NewCoin(common.RuneAsset(), cosmos.NewUint(10000*common.One)),
...
func (s TxOutStoreV39Suite) TestAddOutTxItemWithoutBFT(c *C) {
	w := getHandlerTestWrapper(c, 1, true, true)
	vault := GetRandomVault()
	vault.Coins = common.Coins{
		common.NewCoin(common.BNBAsset, cosmos.NewUint(100*common.One)),
