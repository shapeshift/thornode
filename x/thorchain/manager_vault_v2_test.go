...
type VaultManagerV2TestSuite struct{}

var _ = Suite(&VaultManagerV2TestSuite{})

func (s *VaultManagerV2TestSuite) SetUpSuite(c *C) {
	SetupConfigForTest()
}

func (s *VaultManagerV2TestSuite) TestRagnarokChain(c *C) {
	...
	vaultMgr := NewVaultMgrV2(keeper, mgr.TxOutStore(), mgr.EventMgr())
	...
	mgr1.BeginBlock(ctx)
	vaultMgr1 := NewVaultMgrV2(helper, mgr1.TxOutStore(), mgr1.EventMgr())
...
func (s *VaultManagerV2TestSuite) TestUpdateVaultData(c *C) {
	ctx, k := setupKeeperForTest(c)
	ver := constants.SWVersion
	constAccessor := constants.GetConstantValues(ver)
	helper := NewVaultGenesisSetupTestHelper(k)
	...
	mgr.BeginBlock(ctx)
	vaultMgr := NewVaultMgrV2(helper, mgr.TxOutStore(), mgr.EventMgr())
...
func (s *VaultManagerV2TestSuite) TestCalcBlockRewards(c *C) {
	mgr := NewDummyMgr()
	vaultMgr := NewVaultMgrV2(keeper.KVStoreDummy{}, mgr.TxOutStore(), mgr.EventMgr())
...
func (s *VaultManagerV2TestSuite) TestCalcPoolDeficit(c *C) {
...
func (*VaultManagerV2TestSuite) TestProcessGenesisSetup(c *C) {
	ctx, k := setupKeeperForTest(c)
	ver := constants.SWVersion
	constAccessor := constants.GetConstantValues(ver)
	helper := NewVaultGenesisSetupTestHelper(k)
...
func (*VaultManagerV2TestSuite) TestGetTotalActiveBond(c *C) {
	ctx, k := setupKeeperForTest(c)
	helper := NewVaultGenesisSetupTestHelper(k)
	mgr := NewManagers(helper)
	mgr.BeginBlock(ctx)
...
func (*VaultManagerV2TestSuite) TestGetTotalStakedRune(c *C) {
	ctx, k := setupKeeperForTest(c)
	helper := NewVaultGenesisSetupTestHelper(k)
	mgr := NewManagers(helper)
	mgr.BeginBlock(ctx)
...
func (*VaultManagerV2TestSuite) TestPayPoolRewards(c *C) {
	ctx, k := setupKeeperForTest(c)
	helper := NewVaultGenesisSetupTestHelper(k)
	mgr := NewManagers(helper)
	mgr.BeginBlock(ctx)
...
func (*VaultManagerV2TestSuite) TestFindChainsToRetire(c *C) {
	ctx, k := setupKeeperForTest(c)
	helper := NewVaultGenesisSetupTestHelper(k)
	mgr := NewManagers(helper)
	mgr.BeginBlock(ctx)
...
func (*VaultManagerV2TestSuite) TestRecallChainFunds(c *C) {
	ctx, k := setupKeeperForTest(c)
	helper := NewVaultGenesisSetupTestHelper(k)
	mgr := NewManagers(helper)
	mgr.BeginBlock(ctx)
