...
// newYggMgrVCUR create a new instance of YggMgrVCUR which implement YggManager interface
func newYggMgrVCUR(keeper keeper.Keeper) *YggMgrVCUR {
	return &YggMgrVCUR{
		keeper: keeper,
	}
}
...
// yggdrasil pool
func (ymgr YggMgrVCUR) sendCoinsToYggdrasil(ctx cosmos.Context, coins common.Coins, ygg Vault, mgr Manager) (int, error) {
	var count int
...
func (ymgr YggMgrVCUR) shouldFundYggdrasil(ctx cosmos.Context, asgard, ygg Vault, chain common.Chain) bool {
...
func (ymgr YggMgrVCUR) calcTargetYggCoins(pools []Pool, ygg Vault, yggBond, totalBond, yggFundLimit, minRuneDepth cosmos.Uint) (common.Coins, error) {
...
func (ymgr YggMgrVCUR) abandonYggdrasilVaults(ctx cosmos.Context, mgr Manager) error {
...
func (ymgr YggMgrVCUR) slash(ctx cosmos.Context, slasher Slasher, mgr Manager, pk common.PubKey, ygg Vault) error {
