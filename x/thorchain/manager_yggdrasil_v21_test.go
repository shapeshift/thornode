...
type YggdrasilManagerV21Suite struct{}

var _ = Suite(&YggdrasilManagerV21Suite{})

func (s YggdrasilManagerV21Suite) TestCalcTargetAmounts(c *C) {
	var pools []Pool
	p := NewPool()
	...
	ymgr := NewYggMgrV21(keeper.KVStoreDummy{})
...
func (s YggdrasilManagerV21Suite) TestCalcTargetAmounts2(c *C) {
...
func (s YggdrasilManagerV21Suite) TestCalcTargetAmounts3(c *C) {
...
func (s YggdrasilManagerV21Suite) TestCalcTargetAmounts4(c *C) {
...
func (s YggdrasilManagerV21Suite) TestFund(c *C) {
...
func (s YggdrasilManagerV21Suite) TestNotAvailablePoolAssetWillNotFundYggdrasil(c *C) {
	ctx, k := setupKeeperForTest(c)
	vault := GetRandomVault()
...
func (s YggdrasilManagerV21Suite) TestAbandonYggdrasil(c *C) {
	ctx, k := setupKeeperForTest(c)
	vault := GetRandomVault()
	vault.Coins = common.Coins{
		common.NewCoin(common.RuneAsset(), cosmos.NewUint(10000*common.One)),
...
func (s YggdrasilManagerV21Suite) TestAbandonYggdrasilWithDifferentConditions(c *C) {
	ctx, k := setupKeeperForTest(c)
	vault := GetRandomVault()
	vault.Coins = common.Coins{
		common.NewCoin(common.RuneAsset(), cosmos.NewUint(10000*common.One)),
