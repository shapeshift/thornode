...
// GasMgrV39 implement GasManager interface which will store the gas related events happened in thorchain to memory
// emit GasEvent per block if there are any
type GasMgrV39 struct {
	gasEvent          *EventGas
	gas               common.Gas
...
// NewGasMgrV39 create a new instance of GasMgrV39
func NewGasMgrV39(constantsAccessor constants.ConstantValues, k keeper.Keeper) *GasMgrV39 {
	return &GasMgrV39{
...
func (gm *GasMgrV39) BeginBlock() {
	gm.reset()
}

// AddGasAsset to the EventGas
func (gm *GasMgrV39) AddGasAsset(gas common.Gas, increaseTxCount bool) {
...
// GetGas return gas
func (gm *GasMgrV39) GetGas() common.Gas {
	return gm.gas
}
...
func (gm *GasMgrV39) GetFee(ctx cosmos.Context, chain common.Chain, asset common.Asset) cosmos.Uint {
...
func (gm *GasMgrV39) getRuneInAssetValue(ctx cosmos.Context, transactionFee cosmos.Uint, asset common.Asset) cosmos.Uint {
	if asset.IsSyntheticAsset() {
...
func (gm *GasMgrV39) GetGasRate(ctx cosmos.Context, chain common.Chain) cosmos.Uint {
	outboundTxFee, err := gm.keeper.GetMimir(ctx, constants.OutboundTransactionFee.String())
	if outboundTxFee < 0 || err != nil {
		outboundTxFee = gm.constantsAccessor.GetInt64Value(constants.OutboundTransactionFee)
	}
...
func (gm *GasMgrV39) GetMaxGas(ctx cosmos.Context, chain common.Chain) (common.Coin, error) {
...
func (gm *GasMgrV39) SubGas(gas common.Gas) {
	gm.gas = gm.gas.Sub(gas)
}

// EndBlock emit the events
func (gm *GasMgrV39) EndBlock(ctx cosmos.Context, keeper keeper.Keeper, eventManager EventManager) {
...
func (gm *GasMgrV39) ProcessGas(ctx cosmos.Context, keeper keeper.Keeper) {
