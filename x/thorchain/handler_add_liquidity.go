...
func (h AddLiquidityHandler) handleV37(ctx cosmos.Context, msg MsgAddLiquidity, version semver.Version, constAccessor constants.ConstantValues) (errResult error) {
...
func (h AddLiquidityHandler) handleCurrent(ctx cosmos.Context, msg MsgAddLiquidity, version semver.Version, constAccessor constants.ConstantValues) (errResult error) {
	...
	addLiquidity := h.addLiquidityV37
	if msg.AffiliateBasisPoints.IsZero() {
		return addLiquidity(
			ctx,
			msg.Asset,
...
func (h AddLiquidityHandler) addLiquidityV37(ctx cosmos.Context,
	asset common.Asset,
	addRuneAmount, addAssetAmount cosmos.Uint,
	runeAddr, assetAddr common.Address,
	requestTxHash common.TxID,
