...
// validatorMgrV2 is to manage a list of validators , and rotate them
type validatorMgrV2 struct {
	k          keeper.Keeper
...
func newValidatorMgrV2(k keeper.Keeper, vaultMgr VaultManager, txOutStore TxOutStore, eventMgr EventManager) *validatorMgrV2 {
	return &validatorMgrV2{
		k:          k,
		vaultMgr:   vaultMgr,
		txOutStore: txOutStore,
		eventMgr:   eventMgr,
...
func (vm *validatorMgrV2) BeginBlock(ctx cosmos.Context, constAccessor constants.ConstantValues) error {
...
func (vm *validatorMgrV2) EndBlock(ctx cosmos.Context, mgr Manager, constAccessor constants.ConstantValues) []abci.ValidatorUpdate {
	height := common.BlockHeight(ctx)
...
func (vm *validatorMgrV2) getChangedNodes(ctx cosmos.Context, activeNodes NodeAccounts) (NodeAccounts, NodeAccounts, error) {
...
func (vm *validatorMgrV2) payNodeAccountBondAward(ctx cosmos.Context, na NodeAccount) error {
...
func (vm *validatorMgrV2) processRagnarok(ctx cosmos.Context, mgr Manager, constAccessor constants.ConstantValues) error {
...
func (vm *validatorMgrV2) ragnarokProtocolStage1(ctx cosmos.Context, mgr Manager) error {
	return vm.recallYggFunds(ctx, mgr)
}

func (vm *validatorMgrV2) ragnarokProtocolStage2(ctx cosmos.Context, nth int64, mgr Manager, constAccessor constants.ConstantValues) error {
	// Ragnarok Protocol
...
func (vm *validatorMgrV2) ragnarokBondReward(ctx cosmos.Context) error {
...
func (vm *validatorMgrV2) ragnarokReserve(ctx cosmos.Context, nth int64, mgr Manager) error {
...
func (vm *validatorMgrV2) ragnarokBond(ctx cosmos.Context, nth int64, mgr Manager) error {
...
func (vm *validatorMgrV2) ragnarokPools(ctx cosmos.Context, nth int64, mgr Manager, constAccessor constants.ConstantValues) error {
...
func (vm *validatorMgrV2) RequestYggReturn(ctx cosmos.Context, node NodeAccount, mgr Manager) error {
...
func (vm *validatorMgrV2) recallYggFunds(ctx cosmos.Context, mgr Manager) error {
...
func (vm *validatorMgrV2) setupValidatorNodes(ctx cosmos.Context, height int64, constAccessor constants.ConstantValues) error {
	if height != genesisBlockHeight {
...
func (vm *validatorMgrV2) findBadActors(ctx cosmos.Context) (NodeAccounts, error) {
...
func (vm *validatorMgrV2) findOldActor(ctx cosmos.Context) (NodeAccount, error) {
	na := NodeAccount{}
	nas, err := vm.k.ListActiveNodeAccounts(ctx)
	if err != nil {
		return na, err
...
func (vm *validatorMgrV2) markActor(ctx cosmos.Context, na NodeAccount, reason string) error {
...
func (vm *validatorMgrV2) markOldActor(ctx cosmos.Context, rate int64) error {
...
func (vm *validatorMgrV2) markBadActor(ctx cosmos.Context, rate int64) error {
	if common.BlockHeight(ctx)%rate == 0 {
...
func (vm *validatorMgrV2) markReadyActors(ctx cosmos.Context, constAccessor constants.ConstantValues) error {
...
func (vm *validatorMgrV2) NodeAccountPreflightCheck(ctx cosmos.Context, na NodeAccount, constAccessor constants.ConstantValues) (NodeStatus, error) {
...
func (vm *validatorMgrV2) nextVaultNodeAccounts(ctx cosmos.Context, targetCount int, constAccessor constants.ConstantValues) (NodeAccounts, bool, error) {
