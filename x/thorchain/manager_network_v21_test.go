...
type NetworkManagerV21TestSuite struct{}

var _ = Suite(&NetworkManagerV21TestSuite{})

func (s *NetworkManagerV21TestSuite) SetUpSuite(c *C) {
	SetupConfigForTest()
}

func (s *NetworkManagerV21TestSuite) TestRagnarokChain(c *C) {
	...
	vaultMgr := NewNetworkMgrV21(keeper, mgr.TxOutStore(), mgr.EventMgr())
...
func (s *NetworkManagerV21TestSuite) TestUpdateNetwork(c *C) {
	ctx, k := setupKeeperForTest(c)
	ver := constants.SWVersion
	constAccessor := constants.GetConstantValues(ver)
	helper := NewVaultGenesisSetupTestHelper(k)
...
func (s *NetworkManagerV21TestSuite) TestCalcBlockRewards(c *C) {
	mgr := NewDummyMgr()
	vaultMgr := NewNetworkMgrV21(keeper.KVStoreDummy{}, mgr.TxOutStore(), mgr.EventMgr())
...
func (s *NetworkManagerV21TestSuite) TestCalcPoolDeficit(c *C) {
...
func (*NetworkManagerV21TestSuite) TestProcessGenesisSetup(c *C) {
	ctx, k := setupKeeperForTest(c)
	ver := constants.SWVersion
	constAccessor := constants.GetConstantValues(ver)
	helper := NewVaultGenesisSetupTestHelper(k)
...
func (*NetworkManagerV21TestSuite) TestGetTotalActiveBond(c *C) {
	ctx, k := setupKeeperForTest(c)
	helper := NewVaultGenesisSetupTestHelper(k)
	mgr := NewManagers(helper)
	mgr.BeginBlock(ctx)
...
func (*NetworkManagerV21TestSuite) TestGetTotalLiquidityRune(c *C) {
	ctx, k := setupKeeperForTest(c)
	helper := NewVaultGenesisSetupTestHelper(k)
	mgr := NewManagers(helper)
	mgr.BeginBlock(ctx)
...
func (*NetworkManagerV21TestSuite) TestPayPoolRewards(c *C) {
	ctx, k := setupKeeperForTest(c)
	helper := NewVaultGenesisSetupTestHelper(k)
	mgr := NewManagers(helper)
	mgr.BeginBlock(ctx)
...
func (*NetworkManagerV21TestSuite) TestFindChainsToRetire(c *C) {
	ctx, k := setupKeeperForTest(c)
	helper := NewVaultGenesisSetupTestHelper(k)
	mgr := NewManagers(helper)
	mgr.BeginBlock(ctx)
...
func (*NetworkManagerV21TestSuite) TestRecallChainFunds(c *C) {
	ctx, k := setupKeeperForTest(c)
	helper := NewVaultGenesisSetupTestHelper(k)
	mgr := NewManagers(helper)
	mgr.BeginBlock(ctx)
