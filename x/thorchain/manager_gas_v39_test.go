...
type GasManagerTestV39Suite struct{}

var _ = Suite(&GasManagerTestV39Suite{})

func (GasManagerTestV39Suite) TestGasManagerV39(c *C) {
	ctx, k := setupKeeperForTest(c)
	constAccessor := constants.GetConstantValues(GetCurrentVersion())
	gasMgr := NewGasMgrV39(constAccessor, k)
...
func (GasManagerTestV39Suite) TestGetFee(c *C) {
	ctx, k := setupKeeperForTest(c)
	constAccessor := constants.GetConstantValues(GetCurrentVersion())
	gasMgr := NewGasMgrV39(constAccessor, k)
...
func (GasManagerTestV39Suite) TestDifferentValidations(c *C) {
	ctx, k := setupKeeperForTest(c)
	constAccessor := constants.GetConstantValues(GetCurrentVersion())
	gasMgr := NewGasMgrV39(constAccessor, k)
	gasMgr.BeginBlock()
