...
type TxOutStoreV37Suite struct{}

var _ = Suite(&TxOutStoreV37Suite{})

func (s TxOutStoreV37Suite) TestAddGasFees(c *C) {
...
func (s TxOutStoreV37Suite) TestAddOutTxItem(c *C) {
...
func (s TxOutStoreV37Suite) TestAddOutTxItemWithoutBFT(c *C) {
	w := getHandlerTestWrapper(c, 1, true, true)
	vault := GetRandomVault()
	vault.Coins = common.Coins{
		common.NewCoin(common.BNBAsset, cosmos.NewUint(100*common.One)),
