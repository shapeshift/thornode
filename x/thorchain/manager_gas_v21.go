...
// GasMgrV21 implement GasManager interface which will store the gas related events happened in thorchain to memory
// emit GasEvent per block if there are any
type GasMgrV21 struct {
	gasEvent          *EventGas
	gas               common.Gas
...
// NewGasMgrV21 create a new instance of GasMgrV1
func NewGasMgrV21(constantsAccessor constants.ConstantValues, k keeper.Keeper) *GasMgrV21 {
	return &GasMgrV21{
...
func (gm *GasMgrV21) BeginBlock() {
	gm.reset()
}

// AddGasAsset to the EventGas
func (gm *GasMgrV21) AddGasAsset(gas common.Gas, increaseTxCount bool) {
...
// GetGas return gas
func (gm *GasMgrV21) GetGas() common.Gas {
	return gm.gas
}
...
func (gm *GasMgrV21) GetFee(ctx cosmos.Context, chain common.Chain, asset common.Asset) cosmos.Uint {
...
func (gm *GasMgrV21) GetGasRate(ctx cosmos.Context, chain common.Chain) cosmos.Uint {
	outboundTxFee, err := gm.keeper.GetMimir(ctx, constants.OutboundTransactionFee.String())
	if outboundTxFee < 0 || err != nil {
		outboundTxFee = gm.constantsAccessor.GetInt64Value(constants.OutboundTransactionFee)
	}
...
func (gm *GasMgrV21) GetMaxGas(ctx cosmos.Context, chain common.Chain) (common.Coin, error) {
...
func (gm *GasMgrV21) SubGas(gas common.Gas) {
	gm.gas = gm.gas.Sub(gas)
}

// EndBlock emit the events
func (gm *GasMgrV21) EndBlock(ctx cosmos.Context, keeper keeper.Keeper, eventManager EventManager) {
...
func (gm *GasMgrV21) ProcessGas(ctx cosmos.Context, keeper keeper.Keeper) {
