...
// validatorMgrV6 is to manage a list of validators , and rotate them
type validatorMgrV6 struct {
	k          keeper.Keeper
...
func newValidatorMgrV6(k keeper.Keeper, vaultMgr VaultManager, txOutStore TxOutStore, eventMgr EventManager) *validatorMgrV6 {
	return &validatorMgrV6{
		k:          k,
		vaultMgr:   vaultMgr,
		txOutStore: txOutStore,
		eventMgr:   eventMgr,
...
func (vm *validatorMgrV6) BeginBlock(ctx cosmos.Context, constAccessor constants.ConstantValues) error {
...
func (vm *validatorMgrV6) EndBlock(ctx cosmos.Context, mgr Manager, constAccessor constants.ConstantValues) []abci.ValidatorUpdate {
	height := common.BlockHeight(ctx)
...
func (vm *validatorMgrV6) getChangedNodes(ctx cosmos.Context, activeNodes NodeAccounts) (NodeAccounts, NodeAccounts, error) {
...
func (vm *validatorMgrV6) payNodeAccountBondAward(ctx cosmos.Context, na NodeAccount) error {
...
func (vm *validatorMgrV6) processRagnarok(ctx cosmos.Context, mgr Manager, constAccessor constants.ConstantValues) error {
...
func (vm *validatorMgrV6) getPendingTxOut(ctx cosmos.Context, constAccessor constants.ConstantValues) (int64, error) {
...
func (vm *validatorMgrV6) ragnarokProtocolStage1(ctx cosmos.Context, mgr Manager) error {
	return vm.recallYggFunds(ctx, mgr)
}

func (vm *validatorMgrV6) ragnarokProtocolStage2(ctx cosmos.Context, nth int64, mgr Manager, constAccessor constants.ConstantValues) error {
	// Ragnarok Protocol
...
func (vm *validatorMgrV6) ragnarokBondReward(ctx cosmos.Context) error {
...
func (vm *validatorMgrV6) ragnarokReserve(ctx cosmos.Context, nth int64, mgr Manager) error {
...
func (vm *validatorMgrV6) ragnarokBond(ctx cosmos.Context, nth int64, mgr Manager) error {
...
func (vm *validatorMgrV6) ragnarokPools(ctx cosmos.Context, nth int64, mgr Manager, constAccessor constants.ConstantValues) error {
...
func (vm *validatorMgrV6) RequestYggReturn(ctx cosmos.Context, node NodeAccount, mgr Manager) error {
...
func (vm *validatorMgrV6) setupValidatorNodes(ctx cosmos.Context, height int64, constAccessor constants.ConstantValues) error {
	if height != genesisBlockHeight {
...
func (vm *validatorMgrV6) findBadActors(ctx cosmos.Context) (NodeAccounts, error) {
...
func (vm *validatorMgrV6) findOldActor(ctx cosmos.Context) (NodeAccount, error) {
	na := NodeAccount{}
	nas, err := vm.k.ListActiveNodeAccounts(ctx)
	if err != nil {
		return na, err
...
func (vm *validatorMgrV6) markActor(ctx cosmos.Context, na NodeAccount, reason string) error {
...
func (vm *validatorMgrV6) markOldActor(ctx cosmos.Context, rate int64) error {
...
func (vm *validatorMgrV6) markBadActor(ctx cosmos.Context, rate int64) error {
	if common.BlockHeight(ctx)%rate == 0 {
...
func (vm *validatorMgrV6) markLowerVersion(ctx cosmos.Context, rate int64) error {
	if common.BlockHeight(ctx)%rate == 0 {
...
func (vm *validatorMgrV6) findLowerVersionActor(ctx cosmos.Context) (NodeAccount, error) {
...
func (vm *validatorMgrV6) markReadyActors(ctx cosmos.Context, constAccessor constants.ConstantValues) error {
...
func (vm *validatorMgrV6) NodeAccountPreflightCheck(ctx cosmos.Context, na NodeAccount, constAccessor constants.ConstantValues) (NodeStatus, error) {
...
func (vm *validatorMgrV6) nextVaultNodeAccounts(ctx cosmos.Context, targetCount int, constAccessor constants.ConstantValues) (NodeAccounts, bool, error) {
