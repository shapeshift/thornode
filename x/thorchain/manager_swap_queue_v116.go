...
// newSwapQueueV116 create a new vault manager
func newSwapQueueV116(k keeper.Keeper) *SwapQueueV116 {
	return &SwapQueueV116{
		k:       k,
...
func (vm *SwapQueueV116) FetchQueue(ctx cosmos.Context) (swapItems, error) { // nolint
...
// swapItem list
func (vm *SwapQueueV116) scoreMsgs(ctx cosmos.Context, items swapItems, synthVirtualDepthMult int64) (swapItems, error) {
...
func (vm *SwapQueueV116) getLiquidityFeeAndSlip(ctx cosmos.Context, pool Pool, sourceCoin common.Coin, item *swapItem, virtualDepthMult int64) {
