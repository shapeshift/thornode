...
type YggdrasilManagerV59Suite struct{}

var _ = Suite(&YggdrasilManagerV59Suite{})

func (s YggdrasilManagerV59Suite) TestCalcTargetAmounts(c *C) {
	var pools []Pool
	p := NewPool()
	...
	ymgr := newYggMgrV59(keeper.KVStoreDummy{})
...
func (s YggdrasilManagerV59Suite) TestCalcTargetAmounts2(c *C) {
...
func (s YggdrasilManagerV59Suite) TestCalcTargetAmounts3(c *C) {
...
func (s YggdrasilManagerV59Suite) TestCalcTargetAmounts4(c *C) {
...
func (s YggdrasilManagerV59Suite) TestFund(c *C) {
...
func (s YggdrasilManagerV59Suite) TestNotAvailablePoolAssetWillNotFundYggdrasil(c *C) {
	ctx, k := setupKeeperForTest(c)
	vault := GetRandomVault()
...
func (s YggdrasilManagerV59Suite) TestAbandonYggdrasil(c *C) {
...
func (s YggdrasilManagerV59Suite) TestAbandonYggdrasilWithDifferentConditions(c *C) {
	ctx, mgr := setupManagerForTest(c)
	vault := GetRandomVault()
	vault.Coins = common.Coins{
		common.NewCoin(common.RuneAsset(), cosmos.NewUint(10000*common.One)),
