...
// YggMgrV32 is an implementation of YggManager
type YggMgrV32 struct {
	keeper keeper.Keeper
}

// NewYggMgrV32 create a new instance of YggMgrV32 which implement YggManager interface
func NewYggMgrV32(keeper keeper.Keeper) *YggMgrV32 {
	return &YggMgrV32{
		keeper: keeper,
	}
}
...
func (ymgr YggMgrV32) Fund(ctx cosmos.Context, mgr Manager, constAccessor constants.ConstantValues) error {
...
// yggdrasil pool
func (ymgr YggMgrV32) sendCoinsToYggdrasil(ctx cosmos.Context, coins common.Coins, ygg Vault, mgr Manager, constAccessor constants.ConstantValues) (int, error) {
	var count int
...
func (ymgr YggMgrV32) shouldFundYggdrasil(ctx cosmos.Context, asgard, ygg Vault, chain common.Chain) bool {
...
func (ymgr YggMgrV32) calcTargetYggCoins(pools []Pool, ygg Vault, yggBond, totalBond, yggFundLimit cosmos.Uint) (common.Coins, error) {
...
func (ymgr YggMgrV32) abandonYggdrasilVaults(ctx cosmos.Context, mgr Manager) error {
...
func (ymgr YggMgrV32) slash(ctx cosmos.Context, slasher Slasher, mgr Manager, pk common.PubKey, ygg Vault) error {
