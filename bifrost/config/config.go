...
func applyDefaultConfig() {
	...
	viper.SetDefault("metrics.chains", common.Chains{common.BNBChain, common.BTCChain, common.LTCChain, common.BCHChain, common.ETHChain, common.DOGEChain, common.ATOMChain})
