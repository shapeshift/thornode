...
type DogecoinBlockMetaAccessorTestSuite struct{}

var _ = Suite(
	&DogecoinBlockMetaAccessorTestSuite{},
)

func (s *DogecoinBlockMetaAccessorTestSuite) TestNewBlockMetaAccessor(c *C) {
