...
func (b *CosmosBlockScanner) getFromHttp(url string) ([]byte, error) {
...
func (b *CosmosBlockScanner) getRPCBlock(height int64) ([]string, error) {
	start := time.Now()
	defer func() {
...
func (b *CosmosBlockScanner) BlockRequest(height int64) string {
...
func (b *CosmosBlockScanner) UnmarshalBlock(buf []byte) ([]string, error) {
...
func (c *CosmosBlockScanner) FetchMemPool(height int64) (stypes.TxIn, error) {
	return stypes.TxIn{}, nil
}

func (b *CosmosBlockScanner) FetchTxs(height int64) (stypes.TxIn, error) {
